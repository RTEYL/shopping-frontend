    ...
    return (
      <Container className='items-container'>
        <DropdownButton id="dropdown-item-button" title="Sort By: ">
          <Dropdown.Item onClick={this.handleClick} as="button" value='lowest'>price - lowest</Dropdown.Item>
          <Dropdown.Item onClick={this.handleClick} as="button" value='highest'>price - highest</Dropdown.Item>
        </DropdownButton>
        <Row>
